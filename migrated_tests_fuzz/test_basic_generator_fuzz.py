# Fuzzing tests generated from test_basic_generator.py
# Original test function: test_basic_generator_pt
# Generated 1 variants with mutated inputs

import torch
import numpy as np

def test_basic_generator_pt_fuzz_0(self):
    with self.assertRaisesRegex(NotImplementedError, 'generators'):
        

# Run all fuzz variants
if __name__ == "__main__":
    variants = [test_basic_generator_pt_fuzz_0]
