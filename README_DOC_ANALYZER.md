...
# 爬取 TensorFlow 文档
python3 component/doc_crawler.py tf.keras.layers.Dense --framework tensorflow

# 自动检测框架
python3 component/doc_crawler.py tf.nn.relu

# 保存到文件
python3 component/doc_crawler.py torch.nn.ReLU -o data/pt_relu_doc.json
```
